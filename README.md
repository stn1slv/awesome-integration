...
- Kong
  - [Kong Gateway Certified Associate](https://konghq.com/academy/exam-preparation) - An entry level certification on Kong Gateway for developers, DevOps and architects. 
- Mulesoft
  - [MuleSoft Certified Developer - Level 1](https://training.mulesoft.com/certification/developer-mule4-level1) - The exam validates that a developer has the required knowledge and skills to design, build, test and debug, deploy, and manage basic APIs and integrations: moving from Anypoint Platform to Anypoint Studio and back.
  - [MuleSoft Certified Developer - Level 2](https://training.mulesoft.com/certification/developer-mule4-level2) - The exam validates that a developer is able to independently work on production-ready Mule applications – applications that are ready to be used in a DevOps environment in professional software development projects and address and balance critical non-functional requirements including monitoring, performance, maintainability, reliability, and security.
  - [MuleSoft Certified Integration Architect - Level 1](https://training.mulesoft.com/certification/architect-integration-level1) - It validates that an architect has the required knowledge and skills to work with technical and non-technical stakeholders to translate functional and non-functional requirements into integration interfaces and implementations.
  - [MuleSoft Certified Platform Architect - Level 1](https://training.mulesoft.com/certification/architect-platform-level1) - It validates that an architect has the required knowledge and skills to direct the emergence of an effective application network out of individual integration solutions following API-led connectivity across an organization using Anypoint Platform.
- Oracle
  - [Oracle Business Process Management Suite 12c Certified Implementation Specialist](https://education.oracle.com/oracle-business-process-management-suite-12c-essentials/pexam_1Z0-435) - Designed for individuals who possess a strong foundation and expertise in implementing Oracle Business Process Management Suite 12c solution.
  - [Oracle Data Integrator 12c Certified Implementation Specialist](https://education.oracle.com/oracle-data-integrator-12c-certified-implementation-specialist/trackp_379) - Designed for individuals who possess a strong foundation and expertise in selling or implementing oracle Data Integration 12c solutions.
  - [Oracle Cloud Platform Application Integration 2022 Certified Professional](https://education.oracle.com/oracle-cloud-platform-application-integration-2022-certified-professional/trackp_OCPAI2022CP) - This certification validates the Certified Professional’s understanding of Oracle Application Integration to implement these Cloud services.
  - [Oracle SOA Suite 12c Certified Implementation Specialist](https://education.oracle.com/oracle-soa-suite-12c-essentials/pexam_1Z0-434) - Designed for individuals who possess a strong foundation and expertise in implementing Oracle Soute Suite 12c solutions.
- Red Hat
  - [Red Hat Certified Specialist in API Management](https://www.redhat.com/en/services/certification/red-hat-certified-specialist-api-management) -  Usage the Red Hat 3scale API Management platform to create and maintain enterprise APIs.
  - [Red Hat Certified Specialist in Cloud-native Integration](https://www.redhat.com/en/services/certification/rhcs-cloud-native-integration) -  A creating and maintaining enterprise integration services based on Red Hat®  Fuse, Camel, and APIs.
  - [Red Hat Certified Specialist in Event-Driven Development with Kafka](https://www.redhat.com/en/services/certification/red-hat-certified-specialist-event-driven-development-kafka) - An ability to develop applications using Apache Kafka and Apache Kafka Streams.
  - [Red Hat Certified Specialist in Business Rules](https://www.redhat.com/en/services/certification/rhcs-business-rules) - Check the knowledge, skills, and abilities needed to perform a number of tasks involving the implementation and management of business logic using the Red Hat® JBoss® BRMS.
- TIBCO
  - [TIBCO BusinessWorks Associate](https://www.tibco.com/services/education/certification/tibco-businessworks-associate-certification-exam) - Checking understand Business Studio and TIBCO Cloud Integration, design Application Components(Modules, WSDL, REST API), develop Integration Application, and test, deploy and manage applications.
  - [TIBCO Cloud Integration - Connect Associate](https://www.tibco.com/services/education/certification/tibco-cloud-integration-connect-associate-certification-exam) - Checking usage Connect capability of TIBCO Cloud™ Integration, install On-Premise Agent, create Connections and Integration App and configure Flows.
  ...
  - [TIBCO Cloud Integration Associate](https://www.tibco.com/services/education/certification/tibco-cloud-integration-associate-certification-exam) - Designed to validate the skills and knowledge required to work with TIBCO Cloud Integration, including its Connect, Develop, and Integrate capabilities.
  - [TIBCO Cloud Associate Certification](https://www.tibco.com/services/education/certification/tibco-cloud-associate-certification-exam) - Designed to validate the skills and knowledge required to work with TIBCO Cloud, including its key components and features.
  - [TIBCO BPM Enterprise Associate](https://www.tibco.com/services/education/certification/tibco-bpm-enterprise-associate-certification-exam) - Checking understanding TIBCO BPM's features and capabilities, develop and manage business processes, and deploy and test process applications.
  - [TIBCO Cloud Integration - Connect Certified](https://www.tibco.com/services/education/certification/tibco-cloud-integration-connect-certified-professional-exam) - Checking creation and management connections, ensure connection security, and troubleshoot issues related to connections in TIBCO Cloud Integration.
  - [TIBCO Messaging Certified Professional](https://www.tibco.com/services/education/certification/tibco-messaging-certified-professional-exam) - Designed to validate the skills and knowledge required to work with TIBCO Messaging and its components, including TIBCO Enterprise Message Service (EMS), TIBCO FTL, and TIBCO eFTL.
  - [TIBCO Cloud Integration Certified Professional](https://www.tibco.com/services/education/certification/tibco-cloud-integration-certified-professional-exam) - Checkin knowledge about capabilities and benefits, integrating, developing, and connecting applications, creating APIs using the API Modeler and Mock functionality, and more.
  - [TIBCO BusinessWorks Certified Professional](https://www.tibco.com/services/education/certification/tibco-businessworks-6-certification-exam) - Design, develop, deploy, monitor, and manage TIBCO ActiveMatrix BusinessWorks (BW) applications of average complexity with minimal supervision.
  - [TIBCO Cloud API Management Certified Professional](https://www.tibco.com/services/education/certification/tibco-cloud-api-management-professional-certification-exam) - Implementation TIBCO Cloud Mesh, OAuth Based Security and manage SOAP Services.
  - [TIBCO BPM Enterprise Certified Professional](https://www.tibco.com/services/education/certification/tibco-bpm-enterprise-5-certification-exam) - Designed to validate the skills and knowledge required to design, develop, deploy, and manage business processes using TIBCO Business Process Management (BPM) Enterprise Suite.
  - [TIBCO BusinessWorks Container Edition Certified Professional](https://www.tibco.com/services/education/certification/tibco-businessworks-container-edition-certification-exam) - Develop, deploy and manage TIBCO BusinessWorks Container Edition (BWCE) applications of average complexity with minimal supervision.
