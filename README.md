...
- [Linx](https://linx.software) - Low-code platform for building complex and/or custom APIs, automations, and integrations. Based on a programming paradigm, software engineers use this platform to provide the API or integration service for tools with limited connections to other software and services. 
