...
- [Confluent Platform](https://www.confluent.io/product/confluent-platform) - An enterprise distribution of Apache Kafka with additional features (Control Center, Schema Registry, security plugins, connectors).
